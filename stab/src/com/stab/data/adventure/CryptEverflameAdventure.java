...
public class CryptEverflameAdventure extends Adventure{
	...
	public void init(){
		...
		c.addGUI(t6);
		c.addOption("Empezar la aventura!","CHOICE");
		this.addScene(c);
		...
		c2.addGUI(t7);
		RolledSkillOptionButton rs = new RolledSkillOptionButton();
		rs.setText("Investigar la zona.");
		rs.setSkill(StabConstants.PERCEPTION);
		rs.setDC(15);
		...
		b.setDC(10);
		b.setResults("escena a la que ir si falla", "escena a la que ir si pasa");
