...
public class CryptEverflameAdventure extends Adventure{
	...
	//escena 3
		...
		i3.setSize(Constants.CONTENT, Constants.CONTENT);
	...
	//escena 4
		...
		i4.setSize(Constants.CONTENT, Constants.CONTENT);
	...
	//escena 5
		...
		i5.setSize(Constants.CONTENT, Constants.CONTENT);
	...
	//escena 6 choice 1
		...
		i6.setSize(Constants.CONTENT, Constants.CONTENT);
	...
	//escena 7 choice 2
		...
		i7.setSize(Constants.CONTENT, Constants.CONTENT);
	...
	//escena 8
		...
		Text t8 = new Text();
		t8.setText("Buscas por la zona, pero no consigues encontrar nada que te llame la atención. Al cabo de un rato decides continuar con tu camino. ");
		t8.setSize(Constants.CONTENT,Constants.CONTENT);
		
		Image i8 = new Image();
		i8.setImage("forest$S");
		i8.setPos(Constants.BEGIN, Constants.NEXT);
		i8.setSize(Constants.CONTENT, Constants.CONTENT);
	...
	//escena 9
		...
		Text t9 = new Text();
		t9.setText("Un olor a tabaco de pipa llama poderosamente tu atención. Despues de un rato pensando lo asocias al tabaco que fuma Holgast, el mago de la aldea. " +
		...
		i9.setSize(Constants.CONTENT, Constants.CONTENT);
	...
	//escena 10 choice 3
		...
		Text t10 = new Text();
		t10.setText("Despues de derrotar a los orcos seguis avanzando. Gracias al mapa que llevais es relativamente sencillo encontrar el camino correcto. " +
		...
		i10.setSize(Constants.CONTENT, Constants.CONTENT);
		...
		c10.addGUI(t10);
		c10.addOption(sb10);  // Esto va a dar mas guerra, me temo. Deberiamos dejarlo para más adelante.
	...
	//escena 11 choice 4
		...
		Text t11 = new Text();
		t11.setText("Despues encendeis una pequeña hoguera y empezais a cocinar un estofado con las raciones que hay en " +
	...
	"Pasa otra media hora...");
		...
		i11.setSize(Constants.CONTENT, Constants.CONTENT);
		
		c11.addGUI(t11);
		c11.addOption("Tirar percepcion!", "EVERFLAME1.start");
		this.addScene(c11);
	...
	//escena 12 choice 5
		...
		Text t12 = new Text();
		t12.setText("Veis un gran lobo observandoos escondido entre los matorrales. Claramente intenta huir despues de veros, seguramente con la " +
		...
		i12.setSize(Constants.CONTENT, Constants.CONTENT);
	...
	//escena 13
		...
		Text t13 = new Text();
		t13.setText("El lobo se queda escuchandote ladeando la cabeza. Al cabo de un rato se acerca a ti olisqueando tu mano y con un salto " +
